    ...
    var body: some View {
        NavigationStack {
            ...
            .alert("Success!", isPresented: $showSuccessMessage) {
                Button("View Recipe", role: .cancel) {
                    // This will dismiss the current view and switch to recipes tab
                    dismiss()
                    // Send notification to switch to Recipes tab
            ...
            .onChange(of: viewModel.recipes) { recipes in
                if !recipes.isEmpty {
                    // Show success message when recipes are generated
